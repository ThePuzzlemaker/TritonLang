...
#define EEK
// Defines the macro EEKIFIER to add "EEK" to the end of string str
#macro EEKIFIER(str) str+"EEK"
// Undefines EEK
#undef EEK
...
int main() {
  ...
  io::info(__FUNC__);
  // Uses the macro "EEKIFIER" with the value "test", will print "testeek"
  io::info(m:EEKIFIER("test"))
}
